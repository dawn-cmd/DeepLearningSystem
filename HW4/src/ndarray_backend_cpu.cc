...
#define TILE 8
        ...
        void _strided_index_setter(const AlignedArray* a, AlignedArray* out, std::vector<int32_t> shape, std::vector<int32_t> strides, size_t offset, strided_index_mode mode, int val = -1)
        {
